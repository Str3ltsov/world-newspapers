            ...
            @if ($country->flag)
                <div class="d-flex gap-3">
                    <img src="{{ asset('images/flags/countries/'.$country->flag) }}" 
                        alt="{{ $country->flag_alt }}" class="img-fluid" style="width: 180px; height: 110px">
                ...
                @forelse ($news as $newsRecord)
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <img src="{{ asset('images/news_logos/'.$newsRecord->logo) }}" alt="{{ $newsRecord->logo_alt }}" 
                            style="width: 120px; height: 50px; object-fit: contain; cursor: pointer" onclick="redirectAway('{{ $newsRecord->url }}')">
                        @endif
